...
SITE_TITLE=${WP_SITE_TITLE:-${SITE_TITLE:-fungogogo}}
...
SITE_URL=${WP_SITE_URL:-${SITE_URL:-https://fungogogo.com}}
...
# Activate the bundled fungogogo theme by default (idempotent).
if wp --path=/var/www/html --allow-root theme is-installed fungogogo; then
    wp --path=/var/www/html --allow-root theme activate fungogogo
fi
