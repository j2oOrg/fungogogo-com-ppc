  ...
  <section class="hero" id="home">
    <div class="container hero-grid">
      <div class="hero-copy">
        ...
        <h1 class="hero-title">fungogogo Association Foundation 50/50 Raffle</h1>
        ...
        <p class="hero-sub" style="margin-top:0.8rem;">Operator / Licensee: fungogogo Association Foundation • Authority: Alberta Gaming, Liquor &amp; Cannabis (AGLC). fungogogo is the campaign/brand name only and is not the operator.</p>
      </div>

      <div class="hero-visual">
        <div class="halo"></div>
        <img src="<?php echo esc_url( $hero_image ); ?>" alt="fungogogo Raffle hero">
    ...
    <div class="container">
      ...
      <div class="package-grid">
        ...
        <article class="package-card" style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.12);">
          ...
          fungogogo Association Foundation<br>
  ...
  <section class="regulatory" id="responsible">
    <div class="container">
      <div class="section-head">
        ...
        <p class="section-sub">Operator / Licensee: fungogogo Association Foundation • AGLC Raffle Licence #662961 • Authority: Alberta Gaming, Liquor &amp; Cannabis (AGLC). fungogogo is the campaign/brand name only.</p>
      </div>
      ...
      <div class="rg-grid">
        <div class="rg-card">
          ...
          <p>Operator / Licensee: fungogogo Association Foundation • AGLC Raffle Licence #662961 • 995 tickets • $10 each • Draw: Feb 25, 2026 • One $3,780 winner.</p>
    ...
    <div class="container">
      ...
      <div class="contact-grid">
        <div class="contact-card">
          <h3>Message us</h3>
          <p>Email: <a href="mailto:support@fungogogo.com">support@fungogogo.com</a></p>
...
<div class="fungogogo-modal" id="signupModal" aria-hidden="true">
