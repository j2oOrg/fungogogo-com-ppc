...
<section id="disclaimer" class="notice-slab-n7b6">
  <div class="shell-wrap-z4m2">
    <div class="notice-box-a9r0">
      ...
      <p class="section-sub-p0c6"><strong>fungogogo</strong> is an entertainment-only shell for social game-style browser experiences. There are no deposits, wagers, cashouts, or prizes anywhere on this site.</p>
