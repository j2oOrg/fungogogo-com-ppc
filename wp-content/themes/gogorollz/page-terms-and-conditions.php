...
<section id="terms-and-conditions" class="notice-slab-n7b6">
  <div class="shell-wrap-z4m2">
    <div class="notice-box-a9r0">
      ...
      <p class="section-sub-p0c6">fungogogo provides free-to-play, social casino style experiences for entertainment, previews, and campaign review. No deposits, wagers, or prizes are offered.</p>
      ...
      <p class="section-sub-p0c6">All original designs, text, and visuals on <strong>fungogogo</strong> are protected by copyright and intellectual property laws. Reuse or modification without consent is prohibited.</p>
      ...
      <p class="section-sub-p0c6"><strong>fungogogo</strong> is provided “as-is.” We are not liable for direct, indirect, incidental, or consequential damages arising from use or inability to use the site.</p>

      <h3 class="subheading-c8q2">8. Updates</h3>
      <p class="section-sub-p0c6">We may revise these terms as the platform evolves. Continued use after updates indicates acceptance of the latest version. Questions can be directed to <a href="mailto:hello@fungogogo.com" class="link-accent-m8q5">hello@fungogogo.com</a>.</p>
    </div>
  </div>
</section>
