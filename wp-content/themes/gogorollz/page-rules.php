...
<main class="rules-wrap-g7p2">
  <section class="rules-hero-t9c3" id="rules">
    <div class="shell-wrap-z4m2">
      ...
      <p class="section-sub-p0c6" style="max-width:860px;">Official terms and conditions for fungogogo Raffle, reflecting the ACA raffle structure.</p>
  ...
  <section class="rules-body-q4r8" aria-labelledby="rules-content">
    <div class="shell-wrap-z4m2">
      <div class="rules-highlight-b3n2">
        ...
        <p><strong>Licensee:</strong> fungogogo Raffle</p>
      ...
      <div class="rules-card-m5k1">
        ...
        <ul>
          ...
          <li>Not be an employee or immediate family member of fungogogo Raffle (licensee).</li>
      ...
      <div class="rules-card-m5k1">
        ...
        <ul>
          <li>fungogogo Raffle reserves the right to cancel or modify the raffle if circumstances beyond our control make it necessary.</li>
          <li>In the event of cancellation, all ticket purchasers will receive a full refund.</li>
          <li>All decisions made by fungogogo Raffle regarding this raffle are final.</li>
      ...
      <div class="rules-card-m5k1">
        ...
        <p>fungogogo Raffle, its directors, officers, employees, and agents shall not be liable for:</p>
        <ul>
