...
<head>
  ...
  <meta name="description" content="fungogogo — Licensed raffle with cash prizes, responsible play, and clear rules.">
...
<nav class="navbar navbar-expand-lg nav-rail-q5h8">
  <div class="shell-wrap-z4m2 d-flex align-items-center justify-content-between">
    <a class="navbar-brand" href="<?php echo esc_url( home_url('/') ); ?>">
      <img class="brand-logo-u8b4" src="<?php echo esc_url( $brand ); ?>" alt="fungogogo logo">
      <span class="sr-only">fungogogo</span>
    </a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navMenu" aria-controls="navMenu" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'fungogogo'); ?>">
